...
public class MyANRError extends Error {
    ...
    private MyANRError($._Thread st, long duration) {
    ...
    @NonNull
    static MyANRError New(long duration, @Nullable String prefix, boolean logThreadsWithoutStackTrace) {
    ...
    static MyANRError NewMainOnly(long duration) {
        ...
        return new MyANRError(new $(getThreadTitle(mainThread), mainStackTrace).new _Thread(null), duration);
    }
