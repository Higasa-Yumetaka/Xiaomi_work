...
import com.example.work_liuchangxu.work_0428.Fragment_self_0428_2;
import com.google.android.material.tabs.TabLayout;

public class Main0428Activity_optimized extends AppCompatActivity {
    ...
    FragmentStatePagerAdapter fragmentPagerAdapter = new FragmentStatePagerAdapter(getSupportFragmentManager()){
        ...
        public Fragment getItem(int position) {
            return switch (position) {
                case 0 -> new Fragment_main_0429_2();
